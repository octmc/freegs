...
def JT60SA():
    ...
    coils = [
        (
            "CS1", ShapedCoil([[0.658500, 1.620000], [0.658500, 3.194000], [0.985500, 3.194000], [0.985500, 1.620000], [0.658500, 1.620000]])
        ),
        (
            "CS2", ShapedCoil([[0.658500, 0.015000], [0.658500, 1.589000], [0.985500, 1.589000], [0.985500, 0.015000], [0.658500, 0.015000]])
        ),
        (
            "CS3", ShapedCoil([[0.658500, -1.589000], [0.658500, -0.015000], [0.985500, -0.015000], [0.985500, -1.589000], [0.658500, -1.589000]])
        ),
        (
            "CS4", ShapedCoil([[0.658500, -3.194000], [0.658500, -1.620000], [0.985500, -1.620000], [0.985500, -3.194000], [0.658500, -3.194000]])
        ),
        (
            "EF1", ShapedCoil([[5.636500, 1.012000], [5.636500, 1.346000], [5.965500, 1.346000], [5.965500, 1.012000], [5.636500, 1.012000]])
        ),
        (
            "EF2", ShapedCoil([[4.428500, 3.004000], [4.428500, 3.338000], [4.785500, 3.338000], [4.785500, 3.004000], [4.428500, 3.004000]])
        ),
        (
            "EF3", ShapedCoil([[1.641500, 3.811000], [1.641500, 4.239000], [2.184500, 4.239000], [2.184500, 3.811000], [1.641500, 3.811000]])
        ),
        (
            "EF4", ShapedCoil([[1.641500, -4.422500], [1.641500, -3.811500], [2.184500, -3.811500], [2.184500, -4.422500], [1.641500, -4.422500]])
        ),
        (
            "EF5", ShapedCoil([[3.751000, -3.917000], [3.751000, -3.527000], [4.053000, -3.527000], [4.053000, -3.917000], [3.751000, -3.917000]])
        ),
        (
            "EF6", ShapedCoil([[4.860500, -2.969000], [4.860500, -2.579000], [5.217500, -2.579000], [5.217500, -2.969000], [4.860500, -2.969000]])
        ),
    ]
    ...
    #wall = Wall([1.427, 1.427, 2.34, 3.6, 4.35, 4.2, 3.6, 2.432], [-2.7, 2.7, 2.7,  2.1, 0.47, -1.4, -2.1, -2.7])
    
    # return Machine(coils, wall, R0)
    return Machine(coils, Wall(rwall, zwall),R0=2.97)
